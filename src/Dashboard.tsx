    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-20 bg-purple-800 text-white flex flex-col items-center py-4 space-y-4">
        ...
        <nav className="flex-1 space-y-6 mt-4">
          <Link to="/" className="flex flex-col items-center text-sm hover:text-gray-300">
            <FaHome size={24} />
        ...
        {/* Add Button */}
        <button onClick={handleLogout} className="w-10 h-10 bg-purple-600 rounded-full flex items-center justify-center hover:bg-purple-700">
          <CiLogout size={20} />
        </button>
